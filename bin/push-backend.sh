...
#
# 用法：
#   sh bin/push-backend.sh                    # 服务器信息读 bin/server.env（推荐）
#   sh bin/push-backend.sh [镜像标签]
#   sh bin/push-backend.sh <服务器IP> <SSH用户> [镜像标签]   # 旧写法，兼容
#
# 示例：
#   sh bin/push-backend.sh
#   sh bin/push-backend.sh v2
#
