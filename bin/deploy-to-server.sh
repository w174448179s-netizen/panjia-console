...
#
# 用法：
#   sh bin/deploy-to-server.sh <服务器IP> <SSH用户> [镜像标签]
#
# 示例：
#   sh bin/deploy-to-server.sh 118.24.77.11 ubuntu
#   sh bin/deploy-to-server.sh 118.24.77.11 ubuntu v2
#
# 只发布后端：
#   sh bin/deploy-to-server.sh 118.24.77.11 ubuntu v2 --backend
#
# 只发布前端：
#   sh bin/deploy-to-server.sh 118.24.77.11 ubuntu --frontend
#
...
# ---- 参数 ----
SERVER_ADDR="${1:?用法：sh bin/deploy-to-server.sh <服务器IP> <SSH用户> [镜像标签]}"
